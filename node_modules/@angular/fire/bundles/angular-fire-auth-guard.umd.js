(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/core'), require('@angular/router'), require('rxjs'), require('rxjs/operators'), require('@angular/fire/auth')) :
    typeof define === 'function' && define.amd ? define('@angular/fire/auth-guard', ['@angular/core','exports', '@angular/core', '@angular/router', 'rxjs', 'rxjs/operators', '@angular/fire/auth'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,(global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire['auth-guard'] = {}), global.ng.core, global.ng.router, global.rxjs, global.rxjs.operators, global.angular.fire.auth));
}(this, (function (ɵngcc0,exports, i0, i1, rxjs, operators, i2) { 'use strict';
...
AngularFireAuthGuard.ɵfac = function AngularFireAuthGuard_Factory(t) { return new (t || AngularFireAuthGuard)(ɵngcc0.ɵɵinject(i1.Router), ɵngcc0.ɵɵinject(i2.AngularFireAuth)); };
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(AngularFireAuthGuard, [{
        type: i0.Injectable,
        args: [{
                providedIn: 'any'
            }]
    }], function () { return [{ type: i1.Router }, { type: i2.AngularFireAuth }]; }, null); })();
